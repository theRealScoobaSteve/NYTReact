...
const API_KEY = require("./Routes/key.js");
...
module.exports = APP => {
  ...
  APP.post("/api/search", function(req, res) {
    ...
    mongo
      .DeleteMany("favorites", { isFavorites: false })
      .then(function(res) {})
      .catch(function(err) {
        console.log(err);
      });
  ...
  APP.post("/api/addfav", function(req, res) {
    ...
    mongo
      .Update("favorites", data, { isFavorites: true })
  ...
  APP.post("/api/removefav", function(req, resolve) {
    ...
    mongo
      .Update("favorites", data, { isFavorites: false })
      .then(function(results) {
        send.report = true;
        resolve.json(send);
      });
